...
const ConfettiButton = () => {
    ...
    const generateConfetti = () => {
        ...
        if (container) {
            for (let i = 0; i < 50; i++) {
                ...
                confetti.className = 'confetti ' + SHAPES[Math.floor(Math.random() * 2)];
    ...
    return (
        <div>
            ...
            <div className='fixed top-0 left-0 w-full h-full pointer-events-none' ref={containerRef} id="confetti-container" style={{ position: 'relative' }}></div>
        </div>
    );
}
