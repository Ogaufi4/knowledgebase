...
export default function KitsoChatPage() {
    ...
    const [highlightedIndex, setHighlightedIndex] = useState<number | null>(
        null
    ) // To highlight the latest message
        ...
        if (content.trim() && !isLoading) {
            ...
            try {
                ...
                toast({
                    title: 'Error',
                    description:
                        'Failed to get response from KitsoAI. Please try again.',
                    variant: 'destructive',
                })
            } finally {
                setIsLoading(false)
            ...
            <Card className="mx-auto max-w-2xl">
                <CardHeader>
                    <CardTitle className="text-3xl font-bold">
                        Ask KitsoAI about{' '}
                        {category?.title || 'Indigenous Knowledge'}
                    </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="flex gap-2 mb-4">
                        <button
                            ...
                            onClick={() =>
                                handleSend('What are remedies for headaches?')
                            }
                        >
                        ...
                        <button
                            className="faq-button"
                            onClick={() =>
                                handleSend('What are remedies for back pain?')
                            }
                        >
