        ...
        <CardContent>
          {completed ? (
            <div className="text-center">
              ...
              <Button onClick={() => { setIsVisible(true); displayResults(); }} className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold py-2 px-6 rounded-full transition-all">
                Show Results
              </Button>
            </div>
          ) : (
